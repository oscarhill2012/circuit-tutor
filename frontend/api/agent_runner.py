...
Chunk 3 is the consumer that decides what to do on Reject.
...
class Ledger:
    ...
    Chunk 3 populates this. Chunk 2's tests build it by hand from synthetic
    ToolCallRecord lists.
    """
...
def validate_final_reply(
    ...
    in the new architecture. Every reject branch corresponds to a soundness
    property described in full plan §5.
    ...
    # ---- 3. claim grounding (full plan §5 step 3) -----------------------
    ...
    # ---- 4. visual instruction allow-list (full plan §5 step 4) ---------
    ...
    # ---- 5. verdict turns (full plan §5 step 5) -------------------------
