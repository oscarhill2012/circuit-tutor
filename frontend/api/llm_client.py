...
Keeps the agent loop provider-agnostic — full plan §15 / R2. Swapping to
Anthropic or another provider is a one-file change here, not a rewrite of
agent_runner.py.

Plan ref: tutor-redo/03-agent-loop-behind-flag.md §3.1, full plan §11 R2/R5.
"""
